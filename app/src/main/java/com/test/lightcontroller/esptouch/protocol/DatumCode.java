package com.test.lightcontroller.esptouch.protocol;

import java.net.InetAddress;

import com.test.lightcontroller.esptouch.task.ICodeData;
import com.test.lightcontroller.esptouch.util.ByteUtil;
import com.test.lightcontroller.esptouch.util.CRC8;
